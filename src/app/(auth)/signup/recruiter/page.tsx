...
import { DollarSign, UserPlus, ArrowLeft } from "lucide-react";
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-2 mb-1">
        ...
        <h1 className="text-xl font-bold text-white">Start Recruiting</h1>
      </div>
      <p className="text-gray-400 text-sm mb-5">
        Earn{" "}
        <strong className="text-amber-400">10% lifetime</strong> from every
        contestant you bring in.
      </p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500">
            Your unique referral code will be generated automatically after
            signup. Share it with contestants to start earning.
          </p>
        </div>
