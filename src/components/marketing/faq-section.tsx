...
const faqs = [
  {
    ...
    a: "Each season runs for 90 days across three rounds. Summer enrollment is April\u2013June with the competition running July\u2013September. Winter enrollment is October\u2013December with the competition running January\u2013March. In Round 1, all contestants compete and the top 30 advance. In Round 2, the top 3 are selected. In the Finale, votes determine the winner.",
  },
  {
